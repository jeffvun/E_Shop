    ...
    <main>
        ...
        <div class="main">
            <div class="mininavbar">
                <li class="flist"><i class="fa fa-plus-circle" aria-hidden="true"></i> View Store</li><br>
                <li class="flist"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit Account</li><br>
                <li class="flist" style="width: 140px;"><i class="fa fa-trash-o" aria-hidden="true"></i> Delete Account</li><br>
                <li class="flist"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> <a href="info.php"> View Clients</a></li><br>
            </div>
        </div>
    </main>
