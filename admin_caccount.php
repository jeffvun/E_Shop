...
<body>
        ...
        <div class="main">
            ...
            <div class="mininavbar">
                <li class="flist">
                    ...
                    <span style="padding-left:5px">Add Account</span>
                </li><br>
                <li class="flist">
                    <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                    <span style="padding-left:5px">Edit Account</span>
                </li><br>
                <li class="flist" style="width:150px;">
                    <i class="fa fa-trash-o" aria-hidden="true"></i>
                    <span style="padding-left:5px; width:150px;">
                    <a href="PHP/delete.php?duser='.$id.'">Delete Account</a>
                </span>
                </li><br>
            </div>
            ...
            <div class="container" style="overflow-x:hidden;"><br><br>
    ...
    <?php
        //selecting rows
        $sql_select = "SELECT * FROM client_user LIMIT $start_from,$num_per_page";
	...
	?>
                    <tr>
                        ...
                        <td>
				            <button id="button">
					            <?php
					            echo '<a href="PHP/update.php?upuser='.$id.'" class="edit">Update</a>';?>
				            </button>
				            <button id="button" style="color:red;">
					            <?php 
					                echo '<a href="PHP/delete.php?duser='.$id.'">Delete</a>'; ?>
				            </button>
			            </td>
                    </tr>
        ...
        ?>
            ...
            <?php 
                ...
                for($i=1;$i<=$total_pages;$i++){
                    echo "<a class='active' href='admin_caccount.php?page=".$i."'>".$i."</a>" ;
                }
                    // Close connection
                    $conn->close();
            ?>
